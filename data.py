...
# Load pre-downloaded instruments.csv
instruments_df = pd.read_csv("instruments.csv")

# ✅ Patch GrowwAPI to stop it from downloading or writing
groww.instruments = instruments_df  # Inject loaded instruments
groww._load_instruments = lambda: None  # Disable auto-load
groww._download_and_load_instruments = lambda: instruments_df  # Block file write
