...
if not AUTH_TOKEN:
    raise ValueError("⚠️ GROWW_API_AUTH_TOKEN not set.")

# Load last 60 days and 30 days of data
_, _, df_2, new_live_data = load_data(AUTH_TOKEN)[1:]  # Skip groww object
...
df_live = prepare_df(new_live_data)

# Combine and clean
df = pd.concat([df_2, df_live], ignore_index=True)
...
print("✅ Retrained Buy Accuracy:", accuracy_score(y_test_buy, y_pred_buy))
print("✅ Retrained RR MSE:", mean_squared_error(y_test_rr, y_pred_rr))
